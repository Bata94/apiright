...
func init() {
	genCmd.PersistentFlags().StringVarP(&inputDir, "input", "i", "", "Input directory containing .templ files (required)")
	...
	genCmd.PersistentFlags().StringVarP(&packageName, "package", "p", "uirouter", "Package name for the generated routes.go file")
